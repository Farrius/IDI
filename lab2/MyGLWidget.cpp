  ...
  */  
	...
	case Qt::Key_F:
		...
		if (focus) {
			...
			fview = glm::translate(glm::mat4(1.f), glm::vec3(0, 0, -2*radiEsc));
			fview = glm::rotate(fview, -angleY, glm::vec3(0, 1, 0));
		}
		glUniformMatrix4fv (fviewLoc, 1, GL_FALSE, &fview[0][0]);
		break;
...
void MyGLWidget::initializeGL ()
{
  ...
  focus = true; // false->escena, true->camera
}
...
void MyGLWidget::carregaShaders() {
	...
	fviewLoc = glGetUniformLocation (program->programId(), "fview");
}
